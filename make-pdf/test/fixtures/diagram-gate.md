...
상대적 로컬 이미지 (CRITICAL 회귀 : 렌더링해야합니다, 404) :

![빨간 상자](./diagram-assets/red-box.png)
...
# # 거대한 사진 (다운 스케일 트리거, 다이어그램 힌트 없음)

![큰 noisy 사진](./diagram-assets/huge-noise.png)
